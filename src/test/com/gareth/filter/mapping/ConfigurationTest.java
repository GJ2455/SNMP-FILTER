...
import com.gareth.filter.mapping.TrapTypeOidPrefixes;
...
public class ConfigurationTest {
    ...
    public void configurationLoadsAllPrefixes() {
        ...
        TrapTypeOidPrefixes configuredPrefixes = ConfigurationLoader.loadFromConfigFile(absolutePath);
        assertEquals(8, configuredPrefixes.getTrapTypeOidPrefix().size());
        ...
        List<String> actual = new ArrayList<>(configuredPrefixes.getTrapTypeOidPrefix());
